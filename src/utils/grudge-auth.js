...
export function grudgeSignOut() { ['grudge_auth_token','grudge_user_id','grudge_id','grudge_username','grudge_session_token','grudge-session','discordUser'].forEach(k=>localStorage.removeItem(k)); }
